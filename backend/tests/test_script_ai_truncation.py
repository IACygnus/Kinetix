...
def test_detect_truncation_flags_truncated_response():
    is_truncated, partial, message = _detect_truncation(SAMPLE_TRUNCATED_RESPONSE)
...
def test_detect_truncation_ignores_complete_response():
    is_truncated, partial, message = _detect_truncation(SAMPLE_COMPLETE_RESPONSE)
...
def test_detect_truncation_ignores_non_xml_text():
    ...
    is_truncated, partial, message = _detect_truncation(
